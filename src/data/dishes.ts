...
export const dishes: Dish[] = [
    ...
    optionGroups: [
      {
        ...
        choices: [
          {
            id: "oc-no-topping",
            name: { uk: "Без топінгу", en: "No topping" },
            priceDelta: 0,
            exclusive: true,
          },
  ...
  },
  {
    ...
    description: {
      uk: "Еспресо з ніжною молочною піною.",
      en: "Espresso with delicate steamed milk foam.",
    },
    price: 75,
    emoji: "☕",
  ...
  },
  {
    ...
    description: {
      uk: "Апельсиновий сік свіжого віджиму, без цукру.",
