  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-20 flex justify-center px-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
      <button
        ...
        className="animate-bar-in pointer-events-auto flex min-h-14 w-full max-w-2xl cursor-pointer items-center justify-between gap-3 rounded-full bg-ink-950 px-3 py-2.5 text-paper shadow-xl shadow-ink-950/25 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-300 focus-visible:ring-offset-2 focus-visible:ring-offset-paper"
      >
